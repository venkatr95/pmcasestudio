...
export const metadata: Metadata = {
  ...
  description: 'Create your free PM Case Studio account',
};
  ...
  return (
    <div className="animate-in-up">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-primary-app">Join PM Case Studio</h1>
        <p className="text-muted-app text-sm mt-1">Free forever. No credit card required.</p>
      </div>
      <div className="glass-strong rounded-2xl p-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-muted-app">
            ...
            <Link href="/login" className="text-accent-app font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>
