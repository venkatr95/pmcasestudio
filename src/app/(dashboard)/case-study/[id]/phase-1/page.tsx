...
import { Phase1Client } from '@/components/phases/phase-1-client';
import { parseJSON } from '@/lib/utils';
import type { Phase1Data } from '@/types';

export default async function Phase1Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const existingData = parseJSON<Partial<Phase1Data>>(caseStudy.phases[0]?.data ?? '{}', {});
